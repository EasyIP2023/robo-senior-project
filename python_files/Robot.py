...
class Robot(object):
    def __init__(self, addr=0x60, left_front_id=1, right_front_id=2,left_back_id=3,right_back_id=4, left_front_trim=0, right_front_trim=0,left_back_trim=0,right_back_trim=0,stop_at_exit=True):
